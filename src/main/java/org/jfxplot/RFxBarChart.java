 ...
 */
public class RFxBarChart extends BarChart {

    private String subtitle = null;

    public RFxBarChart(Axis xAxis, Axis yAxis) {
        super(xAxis, yAxis);
    }

    public RFxBarChart(Axis xAxis, Axis yAxis, ObservableList<XYChart.Series> data) {
        super(xAxis, yAxis, data);
    }

    public RFxBarChart(Axis xAxis, Axis yAxis, ObservableList<XYChart.Series> data, double gap) {
